...
const string strMessageMagic = "Ratio Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    nRewardCoinYear = (pindexBest->nHeight % 1000 == 0) ? MAX_MINT_PROOF_OF_STAKE_BONUS : MAX_MINT_PROOF_OF_STAKE;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Ratio", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "vrijdag 11 december 2015 1a35d48c-d3ad-41c1-83d9-60e60e313f89";
        CTransaction txNew;
        txNew.nTime = 1449856502;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime = 1449856502;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce = 1333000 ;
		if(fTestNet)
        {
            block.nNonce = 1333000 ;
        }
		
		uint256 nhashMerkleRoot = uint256("0x9de3ba84b0d6dd95538678219c4e5e46345e16a12dff31fe53dd50cec1228642");
